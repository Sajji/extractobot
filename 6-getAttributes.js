...
const configPath = './config.json'; // Adjust the path as needed
const outputFilePath = './extractedData/allAttributes.json'; // Adjust the path as needed
const assetsFilePath = './extractedData/assets.json'; // Adjust the path as needed
...
const fetchAllAttributes = async () => {
    ...
    while (true) {
        ...
        try {
            ...
            const filteredResults = response.data.results.filter(result => assets.some(asset => asset.id === result.asset.id));
